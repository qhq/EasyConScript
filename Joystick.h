...
#define LOOP_START(x) for(int i=0;i<x||!x;i++){
#define LOOP_END if(Stopping) return;}
#define PROGRAM_END STOP=1;
...
void CollectAndHatch21(void);
void CollectAndHatch41(void);
